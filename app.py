...
<span style="font-size: 0.78rem; color: #94A3B8;">2026 累计收益率历史增长曲线 (%)</span>
<span style="font-size: 0.85rem; font-weight: bold; color: #10B981;">峰值 +{total_live_ret_pct:.2f}%</span>
</div>
</div>"""
